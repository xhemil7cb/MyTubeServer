                    ...
                    <tr>
                      ...
                      <td class="px-2 py-4 whitespace-nowrap text-sm text-gray-500">
                        ...
                        <div class="flex justify-center space-x-1">
                          <button style="margin-right:20px;" onclick="foo('{{ $music['name_on_server'] }}')" class="border-2 border-indigo-200 rounded-md p-1">
                          ...
                          <button style="margin-right:20px;" class="border-2 border-indigo-200 rounded-md p-1">
